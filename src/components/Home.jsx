  ...
  return (
    <div name='home' className ='w-full h-screen bg-[#301728FF]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <p className = 'text-[#8892b0] py-4 max-w-[700px]'>I'm a software engineer specializing in building (and occasionally designing) exceptional digital experiences. Currently, I'm focused on building responsive full-stack web applications.</p>
            <div>
